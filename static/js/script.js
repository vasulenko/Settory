...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#f4f4f5" onclick="today()">Сьогодні: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
...
function cs_over(e) {
	evtTgt(EvtObj(e)).style.background='#f4f4f5';
}
function cs_out(e) {
